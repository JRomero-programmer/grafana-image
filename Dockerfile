...
# Update Title
RUN sed -i 's|<title>\[\[.AppTitle\]\]</title>|<title>Observabilidad en CI/CD</title>|g' /usr/share/grafana/public/views/index.html
RUN sed -i 's|Loading Grafana|Cargando Observabilidad en CI/CD|g' /usr/share/grafana/public/views/index.html
...
RUN sed -i "s|\[\[.NavTree\]\],|nav,|g; \
    ...
    if (help) { help['subTitle'] = 'Observabilidad en CI/CD 4.3.0'; help['children'] = [];} \
    window.grafanaBootData = {|g" \
    /usr/share/grafana/public/views/index.html

# Move Observabilidad en CI/CD to navigation root section
RUN sed -i 's|\[navigation.app_sections\]|\[navigation.app_sections\]\nobservabilidad-ci-cd=root|g' /usr/share/grafana/conf/defaults.ini
...
## Update Title
    -exec sed -i 's|AppTitle="Grafana"|AppTitle="Observabilidad en CI/CD"|g' {} \; \
## Update Login Title
    -exec sed -i 's|LoginTitle="Welcome to Grafana"|LoginTitle="Bienvenido a Observabilidad en CI/CD"|g' {} \; \
